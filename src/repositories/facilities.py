...
class RoomsFacilitiesRepository(BaseRepository):
    ...
    async def set_room_facilities(self, room_id: int, facilities: list[int]) -> None:
        ...
        ids_to_delete: list[int] = list(set(current_facilities_ids) - set(facilities))
        ids_to_insert: list[int] = list(set(facilities) - set(current_facilities_ids))
